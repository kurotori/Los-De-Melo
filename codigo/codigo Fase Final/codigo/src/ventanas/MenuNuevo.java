...
public final class MenuNuevo extends javax.swing.JFrame {
    ...
    public MenuNuevo(DatosSesion datosSesion) {
        ...
        try {
            ...
            setIconImage(Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/imagenes/green_arrow_right.png")));
        } catch (Exception ex ) {
        ...
        ImageIcon icon3 = new ImageIcon(this.getClass().getResource("/imagenes/blu_arrow_right.png"));
        ImageIcon icon4 = new ImageIcon(this.getClass().getResource("/imagenes/blu_arrow_down.png"));
